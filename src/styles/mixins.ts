...
type propsgridForCardsContainer = {
  widthColumn? : string
}

export const gridForCardsContainer = ({widthColumn = '150px'} : propsgridForCardsContainer = {}) => css`
  display: grid;
  grid-template-columns: repeat(auto-fit, ${widthColumn});
`
